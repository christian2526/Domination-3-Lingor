//Dialog by DerZade
class TF47_Freq_Tracker {
	idd = -1;
	movingEnable = false;
	onLoad = "[_this select 0] execVM 'tf47CoreScripts\FrequencyTracker\Scripts\onLoadDialog.sqf'; uiNamespace setVariable ['TF47_Freq_Tracker',_this select 0];";
	onUnLoad = "uiNamespace setVariable ['TF47_Freq_Tracker',nil];";
	class ControlsBackground {
		class back_title: TF47_FreqList_RscText
		{
			idc = 1000;
		...
		class back_main: TF47_FreqList_RscText
		{
			idc = 1001;
			x = 0.365937 * safezoneW + safezoneX;
	...
	class Controls {
		class btn_close: TF47_FreqList_RscButton
		{
			idc = 1600;
			text = "CLOSE";
		...
		class btn_delete: btn_close
		{
			...
			action = "[] execVM 'tf47CoreScripts\FrequencyTracker\Scripts\DeleteItem.sqf'";
		...
		class btn_create: btn_close
		{
			...
			action = "[] execVM 'tf47CoreScripts\FrequencyTracker\Scripts\CreateItem.sqf'";		
			x = 0.572186 * safezoneW + safezoneX;
			y = 0.621 * safezoneH + safezoneY;
			w = 0.0515625 * safezoneW;
		};
		class list_Teams: TF47_FreqList_RscListbox
		{
			idc = 1500;
		...
		class frame_Teams: TF47_FreqList_RscFrame
		{
			idc = 1800;
			x = 0.37625 * safezoneW + safezoneX;
			y = 0.38 * safezoneH + safezoneY;
		...
		class Text_type: TF47_FreqList_RscText
		{
			idc = 1801;
			text = "Type:";
		...
		class combo_type: TF47_FreqList_RscCombo
		{
			idc = 1802;
			x = 0.525 * safezoneW + safezoneX;
		...
		class edit_name: TF47_FreqList_RscEdit
		{
			idc = 1804;
			text = "";
			x = 0.525 * safezoneW + safezoneX;
