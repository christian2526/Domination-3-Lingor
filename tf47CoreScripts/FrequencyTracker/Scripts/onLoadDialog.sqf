...
_listBox = _dialog displayCtrl 1500;
{
	...
	if (isNil "_freq" or _freq == "") then {
		...
		_tooltip = format ["Leader: %1 | Freq.: %2",_x select 2, _freq];
	};
...
//Type ComboBox
_marker =  [["b_inf","Infantry"],["b_air","Helicopter"],["b_plane","Plane"],["b_recon","Recon"],["b_armor","Armor"],["b_hq","Headquarters"],["b_mech_inf","Mechanized Infantry"],["b_motor_inf","Motorized Infantry"],["b_naval","Naval"],["b_support","Support"],["b_uav","UAV"]];
