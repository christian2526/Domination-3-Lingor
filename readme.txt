...
3.65
- Changed: It is now possible to have more than one side on the player side in the normal versions (for example WEST and GUER groups) (WIP, that's why it is not fully implemented in 3.63)
