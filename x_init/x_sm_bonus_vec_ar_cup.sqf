...
switch (d_own_side) do {
	...
	case "WEST": {
		...
		"CUP_B_M1A2_TUSK_MG_US_Army","CUP_B_M2Bradley_USA_W","CUP_B_M2A3Bradley_USA_W","CUP_B_M6LineBacker_USA_W","CUP_B_AV8B_Hydra19","CUP_B_AH1Z","CUP_B_UH1Y_GUNSHIP_USMC","CUP_B_Challenger2_Desert_BAF","CUP_B_Challenger2_2CS_BAF"]
	};
