...
d_x_sm_pos = "d_sm_3" call d_fnc_smmapos; //  steal tank prototype, Military Camp Center, array 2 and 3 = infantry and armor positions
...
if (call d_fnc_checkSHC) then {
	...
	_vec setPos _poss;
	sleep 2.123;
	["specops", 1, "allmen", 1, d_x_sm_pos select 1, 250, true] spawn d_fnc_CreateInf;
	sleep 2.321;
