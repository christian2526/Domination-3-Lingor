...
d_x_sm_pos = "d_sm_69" call d_fnc_smmapos; // index: 69,   Officer near El Villon
d_x_sm_type = "normal"; // "convoy"

if (!isDedicated && {!d_IS_HC_CLIENT}) then {
	d_cur_sm_txt = format [localize "STR_DOM_MISSIONSTRING_1560", "El Villon"];
...
if (call d_fnc_checkSHC) then {
	...
	sleep 2.123;
	["specops", 6, "allmen", 4, _poss, 40, true] spawn d_fnc_CreateInf;
	sleep 2.123;
