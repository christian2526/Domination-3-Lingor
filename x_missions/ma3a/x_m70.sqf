...
d_x_sm_pos = "d_sm_70" call d_fnc_smmapos; // index: 70,   Officer near Ralon
d_x_sm_type = "normal"; // "convoy"

if (!isDedicated && {!d_IS_HC_CLIENT}) then {
	d_cur_sm_txt = format [localize "STR_DOM_MISSIONSTRING_1560", "Ralon"];
...
if (call d_fnc_checkSHC) then {
	...
	sleep 2.123;
	["specops", 1, "allmen", 4, _poss, 100, true] spawn d_fnc_CreateInf;
	sleep 2.123;
