...
d_x_sm_pos = "d_sm_1" call d_fnc_smmapos; // Officer, Camp near Matacan, second array = pos aa
...
if (call d_fnc_checkSHC) then {
	...
	["aa", 1, "tracked_apc", 0, "tank", 0, d_x_sm_pos select 1, 1, 0, false] spawn d_fnc_CreateArmor;
	sleep 2.123;
	...
	[_sm_vec, 1] call d_fnc_setGState;
	sleep 2.123;
