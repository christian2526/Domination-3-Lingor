...
d_x_sm_pos = "d_sm_9" call d_fnc_smmapos; // index: 9,   Helicopter Prototype near Palida
...
if (call d_fnc_checkSHC) then {
	private _poss = if ((floor random 2) == 1) then {d_x_sm_pos select 3} else {d_x_sm_pos select 0};
