...
#ifdef __STRATIS__
d_sm_array =
	[0,1,3,4,6,8,9,11,13,14,19,20,23,29,31,32,36,40,42,44,51,52];
#endif
...
if (call d_fnc_checkSHC) then {
	...
	d_sm_convoy_vehicles = switch (d_enemy_side_short) do {
		...
		case "E": {["rhsgref_ins_btr60","rhsgref_ins_btr70", "rhsgref_ins_bmp2d", "rhsgref_ins_ural_Zu23", "rhsgref_BRDM2_ins", "rhsgref_BRDM2_ATGM_ins", "rhsgref_BRDM2_HQ_ins"]};
