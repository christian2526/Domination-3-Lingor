...
echo "remove _mission-tool directory inside '$TARGET_DIR'"
rm -Rf "$TARGET_DIR/_mission-tool"

echo "remove .gitignore inside '$TARGET_DIR'"
rm -f "$TARGET_DIR/.gitignore"

echo "remove .gitattributes inside '$TARGET_DIR'"
rm -f "$TARGET_DIR/.gitattributes"

echo "remove README.md inside '$TARGET_DIR'"
