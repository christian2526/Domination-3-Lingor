...
0 = [parseText format [ "<br/><t font='PuristaMedium' align='left' size='2.3'> Welcome to Domination! 3</t><br/>  <t align='left' size='1'>  Version 3.64e  </t>"], [safeZoneX + 0.1,safeZoneY + safeZoneH - 0.2,0.9,0.3], nil, 5, 1, 0]  spawn BIS_fnc_textTiles;
...
sleep 12;
"d_introtxt2" cutText ["You are not allowed to monetize videos or streams made while playing Domination in any form!!!\nIf you want to make money make your own content @youtube and twitch heroes!!!\n\nServer owners are also not allowed to monetize their server when using/playing the mission!!!", "PLAIN"];

0 spawn d_fnc_restrictmsg;
