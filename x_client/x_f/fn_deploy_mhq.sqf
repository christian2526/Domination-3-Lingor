...
#else
if (_mhq inArea (d_base_array select 0) || {_mhq inArea (d_base_array select 1) || {surfaceIsWater (getPosATLVisual d_curvec_dialog)}}) exitWith {systemChat (localize "STR_DOM_MISSIONSTRING_213")};
#endif
